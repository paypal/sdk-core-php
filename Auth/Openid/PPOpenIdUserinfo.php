...
class PPOpenIdUserinfo extends PPModel {
		 ...
		 * @param PayPal\Core\Auth\Openid\PPOpenIdAddress $address
		 */
		...
		/**
		 * End-User's preferred address.
		 * @return PayPal\Core\Auth\Openid\PPOpenIdAddress
		 */
